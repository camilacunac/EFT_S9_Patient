...
class PatientControllerTest {
    ...
    void getAllUsers() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/pacientes"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].idPaciente").value(patientList.get(0).getIdPaciente()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].email").value(patientList.get(0).getEmail()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].rut").value(patientList.get(0).getRut()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].idPaciente").value(patientList.get(1).getIdPaciente()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].email").value(patientList.get(1).getEmail()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].rut").value(patientList.get(1).getRut()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[2].idPaciente").value(patientList.get(2).getIdPaciente()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[2].email").value(patientList.get(2).getEmail()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[2].rut").value(patientList.get(2).getRut()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[3].idPaciente").value(patientList.get(3).getIdPaciente()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[3].email").value(patientList.get(3).getEmail()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[3].rut").value(patientList.get(3).getRut()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[4].idPaciente").value(patientList.get(4).getIdPaciente()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[4].email").value(patientList.get(4).getEmail()))
                .andExpect(MockMvcResultMatchers.jsonPath("$[4].rut").value(patientList.get(4).getRut()));
    }
    ...
    void createNewPatientTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/agregar-paciente")
                ...
                .content(
                        "{\"rut\": \"17786044-1\", \"nombre\": \"Gabriela\", \"apellidoPaterno\": \"Ramírez\", \"apellidoMaterno\": \"Vargas\", \"fechaNacimiento\": \"20-09-1997\", \"genero\": \"F\", \"direccion\": \"Avenida Principal 456\", \"telefono\": \"+56998765432\", \"email\": \"gabriela.ramirez@example.com\"}"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.state").value("success"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.error").value(""))
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.email").value(newPatient.getEmail()))
